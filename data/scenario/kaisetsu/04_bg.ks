...
;-----------------------------------------------------------
		...
		原則として、[<y]背景以外のオブジェクトを出すことはできません[>]。[p]
		ベースレイヤーは完全に「背景を出す機能オンリーのレイヤー」だと思ってね。[p]
...
;-----------------------------------------------------------
		...
		[akn/hap]最後に、凝った背景の切り替えを二つ、紹介しておこう。[p]
		[akn/def]一つ目、渦を巻くように暗転。[p]
		
	[chara_hide_all time="0"]
	[layopt layer="message0" visible="false"]
	[layopt layer="fix"      visible="false"]
	
	[image layer="1" x="0"  y="0" width="960" height="640" storage="04_bg.png"       name="maskA" time="1000" wait="false"] [wait time="200"]
