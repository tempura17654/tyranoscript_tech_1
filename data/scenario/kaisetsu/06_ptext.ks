...
;-----------------------------------------------------------
	...
	; [image]x4 見やすくするために画像オブジェクトを表示します。
	...
	; [freeimage]x2 前景レイヤー1番および2番を解放します。
...
;-----------------------------------------------------------
	...
	; ★
		...
		また［ptext］は、[<y]既存の文字オブジェクトの内容を書き換える[>]、ということもできるの。[p]
		実際にやってみよう。[p]
...
;-----------------------------------------------------------
	...
	[wait      time="1400"]
	[freeimage time="1400" layer="1]
	
		…………ね？[p]
		[akn/hap]……以上、すべて覚えることができれば、あなたも立派な文字オブジェクトマスター!![p]
