...
;-----------------------------------------------------------
		...
		……。[p]
		プレイヤーの環境で使えないフォントを指定するとどうなるか、実際に試してみよう。[p][font face="ティラノフォント"]
		...
		まあ、どれかひとつくらいは使えるのがあるでしょう……という作戦。[p][font face="ティラノフォント, メイリオ"]
		...
		で、プレイヤーの環境によっては特定の形式が使えなかったりする。[p]
		たとえば「Internet Explorer」というブラウザでは、「EOT」しか使えないとかね。[p][akn/def]
