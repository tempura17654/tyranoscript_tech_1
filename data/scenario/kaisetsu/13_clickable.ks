...
;-----------------------------------------------------------
		...
		これを使えば、クリッカブルな領域――すなわち[<y]クリック可能な長方形の領域[>]を簡単に作れるよ。[p]
		その領域をクリックすると特定のラベルに飛ぶ、という仕掛けが作れる。[p]
		ようするに「[<y]画像が要らないボタン[>]」だね。[p]
...
;-----------------------------------------------------------
		...
		わっ! クリックしてくれたねっ!![p]
		[akn/def]
		このクリッカブル領域は、[<y]いくつでも配置できる[>]し……。[p]
		[<y]枠のデザインや透明度[>]なんかも、けっこう自由が利くんだよ～。[p]
		いろいろ見せてあげるね。[p]
