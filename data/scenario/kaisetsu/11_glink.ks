...
;-----------------------------------------------------------
		...
		[akn/def]
		……。[p]
		以上が、文字ボタンを出すタグ［glink］の基本的な使い方ですが……。[p]
		[akn/hap]
		……「HTML」「CSS」の心得ある者ならば!![r]さらに発展した使い方も可能です!![p]
		[akn/def]
		……確認する？[l]
	...
	*Part6.2
			...
			それに対して「CSS」を設定してあげると、自分だけのボタンが作れたりしちゃうわけです。[p]
			[akn/hap]
			じゃー、私が作ってみたボタンを披露しちゃう![p]
			[akn/def]
