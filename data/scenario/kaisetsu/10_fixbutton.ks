...
;-----------------------------------------------------------
		...
		……ちなみに「固定」は英語で「フィックス」と訳せるので、フィックスボタンともいうよ。[l][er]
...
;-----------------------------------------------------------
	...
	[button fix="true" target="*Sub_Return" x="145" y="195" graphic="09_button_A1.png" auto_next=no]
		...
		試しにポチポチ押してみるといいと思う。[l][er]
		
		[akn/def]
		……さて、これはふつうの画像ボタンと同様に［button］タグを使って出すものなんだけど、[l][er]
		[akn/hap]
		そのときfixパラメータにtrueを指定する、というところに特殊性があるわ。[l][er]
		そうして出した固定ボタンは、ふつうのボタンが配置される「フリーレイヤー」ではなく、[l][er]
		固定ボタンのためだけの場所に配置されるの。[l][er]
		[akn/def]
		その場所を「固定レイヤー」とか「フィックスレイヤー」とか言う。[l][er]
		
		[akn/dok]
		……。[l][er]
		……なんか難しい話になってきたって？[l][er]
		まあ、難しいと思ったところは、とりあえず気にしないでおこう。[l][er]
...
;-----------------------------------------------------------
	...
	[button fix="true" target="*Sub_Return" x="675" y="195" graphic="09_button_B1.png" auto_next=yes]
		...
		ほい。[l][er]
		右側に、「［return］後に次のタグに進む」固定ボタンを出してみました。[l][er]
		それ以外は左側のボタンと同じだよ。[l][er]
		ぽちぽち押してみて、違いを確かめてみよう。[l][er]
		[akn/dok]
		……。[l][er]
		…………。[l][er]
		………………。[l][er]
...
;-----------------------------------------------------------
	...
	[button fix="true" target="*Sub_Show" x="30" y="30" graphic="10_fixbutton_A.png" auto_next=false]
		...
		ほい。[l][er]
		左上の「i」ボタンを押すと、ティラノスクリプトの情報が見られます。[l][er]
		[akn/hap]
		このへんのスクリプトには、ちょっとした工夫があるんだー。[l][er]
...
;-----------------------------------------------------------
	...
	[clearfix]
		...
		[akn/dok]
		……おや。[l][er]
		画面下に出ていたセーブとかロードとかのボタンも消えたね。[l][er]
		[akn/def]
		そう……実は、画面下に出ていたボタンも一種の固定ボタンだったのです。[l][er]
		あれは「ロールボタン」といいます。「ロール」＝「役割」という意味だ。[l][er]
		ロールボタンはすごく簡単に出すことができるよ。[l][er]
		[akn/hap]
		roleパラメータに「save」や「load」などの所定のキーワードを指定する……だけ!![l][er]
		[akn/def]
...
;-----------------------------------------------------------
	...
	[button fix="true" target="*Sub_Right" x="130" y="30" graphic="10_fixbutton_D.png" auto_next=false]
		...
		使いどころは正直わからないけど……まあ、こういうこともできるのだ。[l][er]
...
;-----------------------------------------------------------
		...
		たぶん使わなきゃいけないときが来るんじゃないかなぁ……と思うんだよね。[l][er]
		[akn/def]
