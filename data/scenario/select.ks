...
; ----------------------------------------------------------
	...
	; これは独自マクロです(→macro.ks)。
	; リストアイテムを表示していきます。
	[list_item text1="01…メッセージの基礎！      " text2="[]                      " storage="01_text.ks      " shiryou="no"]
	[list_item text1="02…メッセージを装飾する    " text2="[]                      " storage="02_decotext.ks  " shiryou="no"]
	[list_item text1="03…レイヤーについて理解する" text2="[]                      " storage="03_layer.ks     " shiryou="no"]
	[list_item text1="04…背景を出す              " text2="[]                      " storage="04_bg.ks"         shiryou="no"]
	[list_item text1="05…画像オブジェクトを出す  " text2="[]                      " storage="05_image.ks     " shiryou="no"]
	[list_item text1="06…文字オブジェクトを出す  " text2="[]                      " storage="06_ptext.ks     " shiryou="no"]
...
; ----------------------------------------------------------
	...
	[index_reset]
	[list_item text1="07…演出文字オブジェクトを出す    " text2="[]                      " storage="07_mtext.ks          " shiryou="yes"]
	[list_item text1="08…キャラクターオブジェクトを出す" text2="[]                      " storage="08_character.ks      " shiryou="no"]
	[list_item text1="09…画像ボタンオブジェクトを出す  " text2="[]                      " storage="09_button.ks         " shiryou="no"]
	[list_item text1="10…固定ボタンオブジェクトを出す  " text2="[]                      " storage="10_fixbutton.ks      " shiryou="no"]
	[list_item text1="11…文字ボタンオブジェクトを出す  " text2="[]                      " storage="11_glink.ks" shiryou="no"]
	[list_item text1="12…オブジェクトを動かす！※        " text2="[]                      " storage="12_anim.ks" shiryou="no"]
...
; ----------------------------------------------------------
	...
	[index_reset]
	[list_item text1="13…クリッカブルマップを出す      " text2="[]                      " storage="13_clickable.ks   " shiryou="no"]
	[list_item text1="14…選択肢の見せ方いろいろ！※      " text2="[]                      " storage="14_select.ks    " shiryou="no"]
	[list_item text1="15…プレイヤーに入力してもらう①  " text2="[]                      " storage="15_input_1.ks" shiryou="no"]
	[list_item text1="16…プレイヤーに入力してもらう②  " text2="[]                      " storage="16_input_2.ks" shiryou="no"]
	[list_item text1="17…ウィンドウをカスタマイズする①" text2="[]                      " storage="17_window_1.ks" shiryou="no"]
...
; ----------------------------------------------------------
	...
	[list_item text1="21…サブルーチンとマクロの話           " text2="[]                      " storage="21_macro.ks" shiryou="no"]
	[list_item text1="22…フォントの話                       " text2="[]                      " storage="22_font.ks" shiryou="no"]
	[list_item text1="23…ミニチュアゲーム①&ensp;脱出ゲーム " text2="[]                      " storage="23_escape.ks" shiryou="no"]
	[anim name="prev" left="-100" time="0" effect="easeOutBack"]
	[anim name="next" left=" 660" time="0" effect="easeOutBack"]
	[return]
